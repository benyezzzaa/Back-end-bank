  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-animation bg-size-200 animate-gradientAnimation">
      <form onSubmit={handleSubmit} className="w-full max-w-md p-8 bg-white rounded-lg shadow-md border border-gray-300">
        <h2 className="text-2xl font-bold mb-4 text-center">Vérifier un Client par CIN</h2>
        <div className="mb-4">
        ...
        <div className="mb-4">
          <label htmlFor="numTel" className="block text-gray-700">Numéro de Téléphone:</label>
          <input
            id="numTel"
            type="text"
            value={numTel}
